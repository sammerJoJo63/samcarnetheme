...
<title>Sam Carne: Front End Web Developer || Making The Web Available To All. One Site At A Time</title>
			...
			<div class="row">
				<div class="col-md-12 clearfix">
					<div class="site-branding">
						<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php bloginfo("template_url") ?>/images/logo.png"></a></h1>
					</div><!-- .site-branding -->
